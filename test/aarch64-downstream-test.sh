...
grep -Fq 'supplement_run_id' "$ROOT/.github/workflows/release-aarch64.yml" || fail "workflow cannot reuse a successful supplemental recovery artifact"
...
grep -Fq '.recovery-packages' "$ROOT/.github/workflows/release-aarch64.yml" || fail "workflow cannot clear successfully recovered package bases from the failure set"
